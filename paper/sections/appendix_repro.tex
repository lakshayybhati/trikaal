...
% NOTE (2026-08-11): the ruling document states tag v1.6.28 and describes itself as the 42nd
% amendment, but `grep -c v1.6.28 docs/m6_prereg.md` returns 0 — the tag is not yet written into
% the amendment log itself. Appendix F records this as an open discrepancy rather than reporting
% the log as carrying 42 tags.
