...
amendment log carries $49$ distinct revision tags, each with its date, its reason, and the
...
\texttt{clauses.2\_mde\_paired.mde\_paired}; \texttt{mde\_paired\_scoring\_only} is the
