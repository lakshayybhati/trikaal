...
the grounds that the training budget was a small fraction of compute-optimal; that is no longer
true --- the pinned budget is $20.00$ tokens per parameter, which is compute-optimal --- and a
model trained to compute-optimal is \emph{more} likely to be calibrated, not less. We concluded
that the near-zero activity branch was the one to plan for.
...
%   table. Budget: 426,033,152 tokens / 21,301,248 params = 20.00 tok/param, per 591ec44.
