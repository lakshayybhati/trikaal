...
% DELETED, not softened. The branch that fires is determined by the manifest, not chosen.
% =============================================================================================
\section{Results}
\label{sec:results}
...
\emph{The five paragraphs below were written on 2026-08-10, before the run was executed and before
any result existed. Exactly one will be retained; the other four are deleted rather than softened.
They are placed here, in advance, so that no interpretation can be composed with an outcome in
front of us. The branch that fires is determined by the verdict manifest, not chosen.}
