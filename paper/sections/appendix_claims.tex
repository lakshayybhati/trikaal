...
%   138 inline `% artifact:` comments across the section files and main.tex
%   51 distinct artifact paths referenced
...
artifact it came from --- $138$ such comments across $51$ distinct artifact paths, stripped from
...
gross IR vs own-lean benchmark, $\Delta$ & $+0.7161$--$+3.4355$ & measured & skill-vs-bias receipt \\
\quad seeds clearing zero at $95\%$ & $1$ of $3$ & measured & same; seed 2, low $+1.5574$ \\
\quad always-long IR of the sample & $+0.3704$ & measured & same; the deflationary alternative \\
amendment log & $49$ revision tags & measured & pre-registration \\
...
Appendix~F.1 records that the amendment log carries $49$ distinct revision tags across
$46$ top-level entries, three tags --- v1.0, v1.6.24 and v1.6.27 --- appearing as in-body
