...
amendment log & $65$ revision tags & measured & pre-registration \\
anchor causal sweep & $420$ of $420$ & measured & Gate-A manifest \\
test suite & $947$ passing & measured & \texttt{pytest} at \texttt{1d60b8c} \\
\bottomrule
\end{tabularx}
\end{center}
...
Appendix~F.1 records that the amendment log carries $65$ distinct revision tags across
$62$ top-level entries, three tags --- v1.0, v1.6.24 and v1.6.27 --- appearing as in-body
