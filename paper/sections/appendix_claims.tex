...
artifact it came from --- $99$ such comments across $47$ distinct artifact paths, stripped from
...
amendment log & $60$ revision tags & measured & pre-registration \\
...
Appendix~F.1 records that the amendment log carries $60$ distinct revision tags across
$57$ top-level entries, three tags --- v1.0, v1.6.24 and v1.6.27 --- appearing as in-body
...
The gate receipt of \cref{sec:res-gate} --- twelve sign accuracies, their base rates and the two
gate outcomes --- is \textbf{measured}, as is the $\lambda$ sweep of \cref{sec:res-lambda}. What
remains \textbf{pending} is everything the ablation would have produced: no verdict, no cell
comparison, no secondary diagnostic. Those bindings are tabulated in Appendix~D.5 and named beside
each slot in the source, so filling them would be mechanical substitution rather than
judgement. And \cref{sec:res-interpretation} no longer carries all five
