...
%   140 inline `% artifact:` comments across the section files and main.tex
%   52 distinct artifact paths referenced
...
artifact it came from --- $140$ such comments across $52$ distinct artifact paths, stripped from
...
\quad seeds clearing zero at $95\%$ & $2$ of $3$ & measured & seed 2 $+1.5574$, seed 4 $+0.0454$ \\
\quad seed 4, $t$ of that $\Delta$ & $1.70$ & derived & $0.9972/0.5876$; normal low $-0.1545$ \\
...
amendment log & $50$ revision tags & measured & pre-registration \\
...
Appendix~F.1 records that the amendment log carries $50$ distinct revision tags across
$47$ top-level entries, three tags --- v1.0, v1.6.24 and v1.6.27 --- appearing as in-body
