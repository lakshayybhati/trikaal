...
amendment helps, we record whether it tightens or loosens the criterion. The log carries $43$
...
budget, which is mechanically checkable: no evaluation artifact carries the pinned step count.
...
% artifact: zero eval artifacts under runs_cloud/ carry provenance.steps_stage2 == 26003; the 23
