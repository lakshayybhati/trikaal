...
split makes a five-machine fan-out purchasable and takes that to $54.1$ hours. It costs
approximately one additional dollar, because the work is identical and only per-machine setup
multiplies, so there was no cost-versus-time trade to make: the change buys time and nothing else.
