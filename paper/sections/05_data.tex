...
and no order book is involved, which is a scope limit (\cref{sec:lim-micro}) and also the reason
...
they are not. The vector is $16$ wide and $13$ live. \Cref{sec:lim-micro} carries what that
costs.
...
through DuckDB, one file per symbol-month. The layout was compacted for query performance, and the
...
mismatches and an unchanged root.
...
\texttt{sha256:\allowbreak 5dfd667d\allowbreak 05b97bda\ldots}, recorded in the manifest alongside per-symbol listing and
